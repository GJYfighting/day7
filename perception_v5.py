...
from day7_env import PerceptionNoise
...
class Perception(Node):
    ...
    def __init__(self):
        ...
        defaults = {
            ...
            'min_object_side_m': 0.035,
            'max_object_side_m': 0.070,
            'publish_debug': True,
            'validation_frames': 0,
            'report_path': str(
            ...
            'expected_center_base_m': [0.32, 0.0, 0.025],
        ...
        initial_domain = self.get_parameter('day7_domain')
